...
| `payment`          | `record`, `reverse`, `preserveCustomerCredit`                                                                                                                                                                      |
...
| `operations`       | `exportBackup`, `restoreBackup`, `recordClose`, `acknowledgeCloseException`, `reopenClose`                                                                                                                         |
...
| `payment.preserveCustomerCredit`                           | records bounded unallocated Payment credit; no account entry        | none                                                     |
