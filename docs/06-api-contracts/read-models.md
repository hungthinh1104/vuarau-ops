...
| `inventory`        | `balances`, `coverage`, `getAdjustment`, `timeline`, `valuation`, `planning`, `stocktakeGet`, `stocktakeActive`, `stocktakeLatestByScope`, `stocktakePreview`, `stocktakePreflight`, `reconciliation`, `evidence`                                                                                                                          |
