...
- Backup V6 introduced and Backup V17 preserves the profile, pricing and operational-evidence facts plus workspace policy versions, commercial supply commitments, supplier observations and demand observations; restore applies them to the recovery workspace before
