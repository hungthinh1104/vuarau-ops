...
- Backup V6 introduced and Backup V15 preserves the profile, pricing and operational-evidence facts plus workspace policy versions, supply commitments, supplier observations and demand observations; restore applies them to the recovery workspace before
