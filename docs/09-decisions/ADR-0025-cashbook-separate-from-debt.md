...
- Backup V6 introduced and Backup V14 preserves source facts, pricing rules, operational evidence, workspace policy versions, supply commitments, supplier observations and movements, not `CashBalance`; restore rebuilds
