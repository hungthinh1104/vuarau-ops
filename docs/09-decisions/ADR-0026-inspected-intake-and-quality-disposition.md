...
Physical truth no longer implies inventory truth. Quarantine remains visible without becoming sellable stock. Purchase void is blocked once active goods arrival exists. Backup V17 and reconciliation include the new lineage.
