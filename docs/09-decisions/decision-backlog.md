...
| ASM-039 | Which inventory valuation basis and cost timing define reproducible COGS?                        | **policy-blocked**        | No valuation or COGS policy; keep cost/profit unavailable and preserve source facts                                                                                                   | Owner + accountant, before valuation, COGS or margin reporting ([worksheet](m24-policy-closure-worksheet.md))                                                     |
| ASM-040 | How do waste, returns, claims, credits and corrections affect cost and profit?                   | **policy-blocked**        | No cross-dimension cost policy; do not infer COGS, margin or payable effects                                                                                                          | Owner + accountant + warehouse, before cost effects are reported ([worksheet](m24-policy-closure-worksheet.md))                                                   |
| ASM-041 | What terms, allocation and collection priority define customer debt reporting?                   | **policy-blocked**        | Existing ledgers remain canonical; no aging, allocation or collection recommendation is available without field policy                                                                | Owner + accountant, before aging or collection actions ([worksheet](m24-policy-closure-worksheet.md))                                                             |
| ASM-042 | Which minimum, target, lead-time and reorder values define inventory risk?                       | **policy-blocked**        | No planning or stock-risk state; current inventory reads remain source-backed quantities only                                                                                         | Owner + warehouse + purchaser, before reorder or stock-risk actions ([worksheet](m24-policy-closure-worksheet.md))                                                |
| ASM-043 | Does a stocktake need a session, variance approval and reopen path?                              | **policy-blocked**        | Individual attributable adjustments remain the only available representation; no stocktake workflow is exposed                                                                        | Owner + warehouse, before session/variance implementation ([worksheet](m24-policy-closure-worksheet.md))                                                          |
| ASM-044 | How should anonymous or walk-in cash sales represent identity, payment and returns?              | **policy-blocked**        | Current Sale requires a real Customer; no fake customer or inferred debt path is allowed                                                                                              | Owner + sales + accountant, before anonymous-sale implementation ([worksheet](m24-policy-closure-worksheet.md))                                                   |
| ASM-045 | What must be counted, signed off and corrected at shift or business-day close?                   | **policy-blocked**        | Reports and integrity reads are not a close event; no close state is exposed                                                                                                          | Owner + accountant + workers, before close workflow implementation ([worksheet](m24-policy-closure-worksheet.md))                                                 |
| ASM-046 | How are bank deposits and external statements matched to Cashbook facts?                         | **policy-blocked**        | No statement-matching or settlement policy; Cashbook source facts remain unchanged                                                                                                    | Owner + accountant, before deposit reconciliation implementation ([worksheet](m24-policy-closure-worksheet.md))                                                   |
| ASM-047 | Which Supplier relationship facts and authorities must be maintained?                            | **policy-blocked**        | Supplier master and Purchase facts remain current scope; no inferred role/origin/relationship data                                                                                    | Owner + purchaser + warehouse, before Supplier catalogue expansion ([worksheet](m24-policy-closure-worksheet.md))                                                 |
| ASM-048 | Which Supplier delivery, quality, return and credit facts support performance decisions?         | **policy-blocked**        | No Supplier score or recommendation; missing/disputed evidence must remain visible                                                                                                    | Owner + purchaser + receiver, before performance or recommendation surfaces ([worksheet](m24-policy-closure-worksheet.md))                                        |
