...
Identity/workspace
  ...
  → Supplier → Supply Commitment → Purchase → supplier account → Receiving → Inventory
  → Delivery → Return
...
| UC-SUPPLY-COMMITMENT-001 | Create and edit a Supply Commitment draft       | `supply_commitment.create`               | implemented    | [supply commitment](supply-commitment-use-cases.md)                        |
| UC-SUPPLY-COMMITMENT-002 | Confirm a Supply Commitment                     | `supply_commitment.confirm`              | implemented    | [supply commitment](supply-commitment-use-cases.md)                        |
| UC-SUPPLY-COMMITMENT-003 | Cancel or supersede a Supply Commitment         | `supply_commitment.cancel`               | implemented    | [supply commitment](supply-commitment-use-cases.md)                        |
| UC-SUPPLY-COMMITMENT-004 | View and list Supply Commitments                | `supply_commitment.read`                 | implemented    | [supply commitment](supply-commitment-use-cases.md)                        |
...
| UC-PAYMENT-004           | Preserve unallocated Payment as customer credit | `debt.allocate`                          | implemented    | [UC-PAYMENT-004](UC-PAYMENT-004-preserve-customer-credit.md)               |
...
| UC-ACCOUNT-006           | Apply explicit credit control at Sale post      | `sale.post`                              | implemented    | [UC-ACCOUNT-006](UC-ACCOUNT-006-credit-control.md)                         |
...
| UC-DELIVERY-006          | Record fulfilment-remainder decision            | `delivery.recordFulfilmentRemainderCase` | implemented    | [UC-DELIVERY-006](UC-DELIVERY-006-record-fulfilment-remainder.md)          |
| UC-DELIVERY-007          | Settle physical-return consequence              | `delivery.recordReturnSettlement`        | implemented    | [UC-DELIVERY-007](UC-DELIVERY-007-record-return-settlement.md)             |
