...
Backup V17 exports master codes, price rules, cost/reconciliation/debt/supply-commitment/supplier/demand observations, Customer Orders, Supply Commitments, workspace policy versions and every physical fact as canonical table-shaped records. Restore rejects missing cross-references, rebuilds inventory projections and succeeds only when source lineage reconciles.
