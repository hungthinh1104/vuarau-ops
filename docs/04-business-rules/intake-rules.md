...
- **BR-INTAKE-013** — Backup V17 includes issue masters, price rules, cost/reconciliation/debt/supply-commitment/supplier/demand observations, Customer Orders, Supply Commitments, workspace policy versions and every arrival, inspection, disposition, allocation, reversal and resulting inventory movement. Restore validates references and reconciles inventory before success.
