...
- **BR-INTAKE-013** — Backup V10 includes issue masters, price rules, cost and reconciliation observations and every arrival, inspection, disposition, allocation, reversal and resulting inventory movement. Restore validates references and reconciles inventory before success.
