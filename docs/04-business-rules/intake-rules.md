...
- **BR-INTAKE-013** — Backup V11 includes issue masters, price rules, cost/reconciliation/debt observations and every arrival, inspection, disposition, allocation, reversal and resulting inventory movement. Restore validates references and reconciles inventory before success.
