...
| `CUSTOMER_CREDIT_PRESERVATION_PAYMENT_INVALID`     | Preservation does not reference a Payment in this workspace                                                               | `paymentReference`                                                    | no        | BR-PAYMENT-009               | `BAD_REQUEST`           |
| `CUSTOMER_CREDIT_PRESERVATION_CUSTOMER_MISMATCH`   | Preservation customer differs from the referenced Payment                                                                 | `paymentReference`, `customerId`                                      | no        | BR-PAYMENT-009               | `BAD_REQUEST`           |
