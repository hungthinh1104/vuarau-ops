...
ordinary workflow facts, the outstanding-delivery source condition, each canonical
...
same five exception keys; application tests must prove that resolving an
