...
Supplier detail may show the observed `confirmed` Purchase-line price history,
including Product identity, quantity and source timestamps. This read is evidence
only; it must not be presented as a normalized supplier price, margin, ranking or
recommendation while ASM-047/048 remain open.
