...
export const deliveryReturnSettlementIdSchema = z.uuid().brand<"DeliveryReturnSettlementId">();
export type DeliveryReturnSettlementId = z.infer<typeof deliveryReturnSettlementIdSchema>;
export const fulfilmentRemainderCaseIdSchema = z.uuid().brand<"FulfilmentRemainderCaseId">();
export type FulfilmentRemainderCaseId = z.infer<typeof fulfilmentRemainderCaseIdSchema>;
...
export const customerOrderIdSchema = z.uuid().brand<"CustomerOrderId">();
export type CustomerOrderId = z.infer<typeof customerOrderIdSchema>;
