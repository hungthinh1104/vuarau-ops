...
export const AUDIT_AGGREGATE_TYPES = [
  ...
  "supply_commitment",
  "payment",
  "customer_payment_credit_preservation",
  "debt",
  "membership",
  "product",
  "price_rule",
  ...
  "stocktake",
  "delivery",
  "delivery_return_settlement",
  "fulfilment_remainder_case",
  "document",
  "cash_account",
  "expense",
  "cash_transfer",
  "cash",
  "operational_close",
  "operational_close_exception_acknowledgement",
  "cash_statement_match",
  "quality_issue_code",
  "goods_arrival",
  "quality_inspection",
  "quality_disposition",
...
export const AUDIT_ACTIONS = [
  ...
  "supply_commitment.draft_created",
  "supply_commitment.draft_edited",
  "supply_commitment.confirmed",
  "supply_commitment.cancelled",
  "payment.recorded",
  "payment.reversed",
  "payment.customer_credit_preserved",
  ...
  "delivery.delivered",
  "delivery.returned",
  "delivery_return_settlement.recorded",
  "fulfilment_remainder_case.recorded",
  "document.generated",
  "document.shared",
  ...
  "operational_close.recorded",
  "operational_close.reopened",
  "operational_close.exception_acknowledged",
  "cash_statement_match.recorded",
  "cash_statement_match.reversed",
