...
export const workspaceBackupPayloadV18Schema = workspaceBackupPayloadV17Schema.extend({
  stocktakeSessions: z.array(backupRecordSchema),
  stocktakeCounts: z.array(backupRecordSchema),
});
export const workspaceBackupV18Schema = z.object({
  format: z.literal("vuarau.workspace-backup"),
  version: z.literal(18),
  sourceWorkspaceId: workspaceIdSchema,
  createdAt: isoInstantSchema,
  schemaCompatibility: z.literal("m34-stocktake-planning"),
  recordCounts: z.record(z.string(), z.int().nonnegative()),
  payload: workspaceBackupPayloadV18Schema,
  digest: z.string().regex(/^[a-f0-9]{64}$/),
});
export type WorkspaceBackupV18 = z.infer<typeof workspaceBackupV18Schema>;
export const workspaceBackupPayloadV19Schema = workspaceBackupPayloadV18Schema.extend({
  operationalCloses: z.array(backupRecordSchema),
  operationalCloseReopens: z.array(backupRecordSchema),
  cashStatementMatches: z.array(backupRecordSchema),
  cashStatementMatchReversals: z.array(backupRecordSchema),
});
export const workspaceBackupV19Schema = z.object({
  format: z.literal("vuarau.workspace-backup"),
  version: z.literal(19),
  sourceWorkspaceId: workspaceIdSchema,
  createdAt: isoInstantSchema,
  schemaCompatibility: z.literal("m35-close-bank-reconciliation"),
  recordCounts: z.record(z.string(), z.int().nonnegative()),
  payload: workspaceBackupPayloadV19Schema,
  digest: z.string().regex(/^[a-f0-9]{64}$/),
});
export type WorkspaceBackupV19 = z.infer<typeof workspaceBackupV19Schema>;
export const workspaceBackupPayloadV20Schema = workspaceBackupPayloadV19Schema.extend({
  deliveryReturnSettlements: z.array(backupRecordSchema).default([]),
});
export const workspaceBackupV20Schema = z.object({
  format: z.literal("vuarau.workspace-backup"),
  version: z.literal(20),
  sourceWorkspaceId: workspaceIdSchema,
  createdAt: isoInstantSchema,
  schemaCompatibility: z.literal("m36-return-settlement"),
  recordCounts: z.record(z.string(), z.int().nonnegative()),
  payload: workspaceBackupPayloadV20Schema,
  digest: z.string().regex(/^[a-f0-9]{64}$/),
});
...
export const workspaceBackupPayloadV22Schema = workspaceBackupPayloadV21Schema.extend({
  operationalCloseExceptionAcknowledgements: z.array(backupRecordSchema).default([]),
});
export const workspaceBackupV22Schema = z.object({
  format: z.literal("vuarau.workspace-backup"),
  version: z.literal(22),
  sourceWorkspaceId: workspaceIdSchema,
  createdAt: isoInstantSchema,
  schemaCompatibility: z.literal("m38-close-exception-acknowledgement"),
  recordCounts: z.record(z.string(), z.int().nonnegative()),
  payload: workspaceBackupPayloadV22Schema,
  digest: z.string().regex(/^[a-f0-9]{64}$/),
});
export type WorkspaceBackupV22 = z.infer<typeof workspaceBackupV22Schema>;
export const workspaceBackupPayloadV23Schema = workspaceBackupPayloadV22Schema.extend({
  customerPaymentCreditPreservations: z.array(backupRecordSchema).default([]),
});
export const workspaceBackupV23Schema = z.object({
  format: z.literal("vuarau.workspace-backup"),
  version: z.literal(23),
  sourceWorkspaceId: workspaceIdSchema,
  createdAt: isoInstantSchema,
  schemaCompatibility: z.literal("m39-customer-payment-credit-preservation"),
  recordCounts: z.record(z.string(), z.int().nonnegative()),
  payload: workspaceBackupPayloadV23Schema,
  digest: z.string().regex(/^[a-f0-9]{64}$/),
});
export type WorkspaceBackupV23 = z.infer<typeof workspaceBackupV23Schema>;
