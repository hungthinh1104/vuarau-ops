...
export const orderConfirmationEntry: DebtLedgerEntryDto = {
...
export const paymentEntry: DebtLedgerEntryDto = {
...
export const ledgerWithOrderAndPayment: readonly DebtLedgerEntryDto[] = [
  orderConfirmationEntry,
  paymentEntry,
];
