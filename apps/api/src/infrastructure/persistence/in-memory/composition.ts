...
import { createFulfilmentRemainderRepositories } from "./repositories/fulfilment-remainder.ts";
...
import { createCloseRepositories } from "./repositories/close.ts";
...
import { createCloseReads } from "./reads/close.ts";
...
export const createInMemoryRepositories = (store: Store, ids: IdGenerator): Repositories => ({
  ...
  ...createFulfilmentRemainderRepositories(store),
