...
const TRANSPORT_CODE: Partial<Record<DomainRejectionCode, TRPCError["code"]>> = {
  ...
  PAYMENT_ALREADY_EXISTS: "CONFLICT",
  PRODUCT_NOT_FOUND: "NOT_FOUND",
  SALE_ALREADY_POSTED: "CONFLICT",
  SALE_ALREADY_VOIDED: "CONFLICT",
  SALE_ALREADY_DISCARDED: "CONFLICT",
  CUSTOMER_VERSION_CONFLICT: "CONFLICT",
  PRODUCT_VERSION_CONFLICT: "CONFLICT",
  CUSTOMER_ALREADY_INACTIVE: "CONFLICT",
  WORKSPACE_LAST_OWNER: "CONFLICT",
  SALE_NOT_POSTED: "CONFLICT",
  SALE_HAS_ACTIVE_PAYMENT_ALLOCATIONS: "CONFLICT",
  SALE_IMMUTABLE: "CONFLICT",
  SALE_VERSION_CONFLICT: "CONFLICT",
  PAYMENT_ALREADY_REVERSED: "CONFLICT",
  PAYMENT_REVERSAL_WOULD_EXCEED_ALLOCATIONS: "CONFLICT",
  PAYMENT_VERSION_CONFLICT: "CONFLICT",
  DUPLICATE_COMMAND: "CONFLICT",
  IDEMPOTENCY_KEY_REUSED_WITH_DIFFERENT_COMMAND: "CONFLICT",
  IDEMPOTENCY_KEY_REUSED_WITH_DIFFERENT_PAYLOAD: "CONFLICT",
  COMMAND_IN_PROGRESS: "CONFLICT",
  COMMAND_RECEIPT_RESULT_INVALID: "CONFLICT",
  PILOT_SCOPE_EXCLUDED: "FORBIDDEN",
  PERSISTED_NUMBER_OUT_OF_RANGE: "INTERNAL_SERVER_ERROR",
};
