...
export function Toaster() {
  return (
    <SonnerToaster
      ...
      toastOptions={{
        className:
          "pointer-events-auto group flex items-center gap-3 rounded-card border border-border bg-surface px-4 py-3 text-body-sm text-ink",
        classNames: {
          toast:
            "pointer-events-auto group flex items-center gap-3 rounded-card border border-border bg-surface px-4 py-3 text-body-sm text-ink",
          description: "text-ink-muted",
          actionButton:
            "pointer-events-auto ml-auto rounded-button bg-brand px-3 py-1.5 text-label font-semibold text-white hover:bg-brand-hover",
          cancelButton:
            "pointer-events-auto ml-auto rounded-button bg-canvas px-3 py-1.5 text-label font-semibold text-ink hover:bg-border",
