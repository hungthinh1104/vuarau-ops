...
export const accountTimeline: readonly AccountTimelineEntryDto[] = [
  {
    ...
    classification: "receivable",
    source: { type: "sale_posting", id: POSTED_SALE_ID, label: "Đơn 875.000 ₫ — 20/07" },
  ...
  },
  {
    ...
    classification: "receivable",
    source: { type: "payment", id: PAYMENT_ID, label: "Tiền mặt 500.000 ₫" },
    reversalOfEntryId: null,
    reasonCode: null,
    reason: null,
  ...
  },
  {
    ...
    classification: "customer_credit",
    source: { type: "sale_void", id: SALE_VOID_ID, label: `Hoàn tác đơn ${VOIDED_SALE_ID}` },
